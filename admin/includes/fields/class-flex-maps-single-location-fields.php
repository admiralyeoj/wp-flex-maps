...
class Flex_Maps_Single_Location_Fields extends Flex_Maps_Fields {
  ...
  protected function get_general_fields() {
    if($fields = wp_cache_get('fm_location_fields_general'))
      return $fields;
    ...
    wp_cache_set('fm_location_fields_general', $fields);

    return $fields;
  }

  protected function get_address_fields() {
    if($fields = wp_cache_get('fm_location_fields_address'))
      return $fields;
    ...
    wp_cache_set('fm_location_fields_address', $fields);

    return $fields;
  }

  protected function get_extra_fields() {
    if($fields = wp_cache_get('fm_fields_extra'))
      return $fields;

    $fields = apply_filters('fm_fields_extra', array());
    wp_cache_set('fm_fields_extra', $fields);

    return $fields;
  }

  protected function get_field_location() {
    if($location = wp_cache_get('fm_single_location_fields_location'))
      return $location;
  ...
  public static function get_single_location_fields() {
    ...
    wp_cache_set('fm_single_location_fields', $merge_array);
    return $merge_array;
  }
}